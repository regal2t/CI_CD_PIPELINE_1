...
<table class="table table-bordered" id="resultTable" data-responsive="table" style="text-align: left;">
	...
	<tbody>
			...
			<td><a  title="Click To View Customer" href="viewcustomer.php?id=<?php echo $row['customer_name']; ?>"><button class="btn btn-warning btn-mini"><i class="icon-list"></i> View </button></a> 
			</td>
